...
execute if score RR.config.set_same_rules random_rules matches 1 run data modify storage random_rules copy set from storage util storage[0].data.RR.rules
