...
execute if score RR.config.set_same_rules random_rules matches 1 run scoreboard players operation @a[limit=1,tag=RR.set_rules.target] RR.num_rules = RR.config.num_rules_when_setting random_rules
